...
import { idlFactory } from './ic-rand.did.js';
export { idlFactory } from './ic-rand.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.IC-RAND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ic-rand.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ic-rand canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ic-rand.did.js")._SERVICE>}
 */
export const ic-rand = createActor(canisterId);
